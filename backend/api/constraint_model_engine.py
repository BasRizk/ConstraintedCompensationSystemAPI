...
class ConstraintModelEngine:
    ...
    def query_model(self, compensation_slot):
        ...
        """
        slots_cleaned = self.query_formater.clean_formatted_slots(self.all_slots)
        ...
        query_statement = self.query_formater.create_query(slots_digitized,
                                                           holiday,
                                                           ready_compensation_slot)
    ...
    def ready_compensation(self, compensation_slot):
        ...
        """
        if self.query_formater.validate_slot(compensation_slot):
    ...
    def get_all_groups(self):
        """
        List the set of all study groups
        """
        _, groups, _ =\
